- [Back](https://support.typoraio.cn/)
...
- Span 元素
  ...
  - [表情符号 :smile:](https://support.typoraio.cn/zh/Markdown-Reference/#表情符号-smile)
...
输入 `$$`, 然后按“return”键将触发一个接受*Tex / LaTex*源代码的输入区域。以下是一个例子： V1×V2=∣∣∣∣∣i∂X∂u∂X∂vj∂Y∂u∂Y∂vk00∣∣∣∣∣V1×V2=|ijk∂X∂u∂Y∂u0∂X∂v∂Y∂v0|
