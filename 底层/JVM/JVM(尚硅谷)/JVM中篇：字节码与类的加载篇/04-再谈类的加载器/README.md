...
![image-20221229180222999](./assets/image-20221229180222999.png)
...
![image-20221229180233096](./assets/image-20221229180233096.png)
...
- 加载扩展类和应用程序类加载器，并指定为他们的父类加载器。
  ...
  ![image-20221229180252832](./assets/image-20221229180252832.png)
...
**执行结果：**
![image-20221229180259500](./assets/image-20221229180259500.png)
...
- 从java.ext.dirs系统属性所指定的目录中加载类库，或从JDK的安装目录的jre/lib/ext子目录下加载类库。如果用户创建的JAR放在此目录下，也会自动由扩展类加载器加载。
  ...
  ![image-20221229180308386](./assets/image-20221229180308386.png)
...
**执行结果：**
  ...
  ![image-20221229180326211](./assets/image-20221229180326211.png)
...
![image-20221229180335576](./assets/image-20221229180335576.png)
...
![image-20221229180346363](./assets/image-20221229180346363.png)
...
![image-20221229180356228](./assets/image-20221229180356228.png)
...
![image-20221229180405366](./assets/image-20221229180405366.png)
...
![image-20221229180414383](./assets/image-20221229180414383.png)

![image-20221229180422250](./assets/image-20221229180422250.png)
...
![image-20221229180431436](./assets/image-20221229180431436.png)
...
![image-20221229180440305](./assets/image-20221229180440305.png)
<hr/>
...
![image-20221229180447133](./assets/image-20221229180447133.png)
...
![image-20221229180454104](./assets/image-20221229180454104.png)

## 6.3. JDK1.2时期

在Java1.2版本中，再次改进了安全机制，增加了**代码签名**。不论本地代码或是远程代码，都会按照用户的安全策略设定，由类加载器加载到虚拟机中权限不同的运行空间，来实现差异化的代码执行权限控制。如下图所示JDK1.2安全模型：

![image-20221229180500755](./assets/image-20221229180500755.png)
...
![image-20221229180507817](./assets/image-20221229180507817.png)
<hr/>
...
![image-20221229180515514](./assets/image-20221229180515514.png)
...
![image-20221229180525789](./assets/image-20221229180525789.png)

![image-20221229180532841](./assets/image-20221229180532841.png)

![image-20221229180539826](./assets/image-20221229180539826.png)

![image-20221229180546778](./assets/image-20221229180546778.png)
