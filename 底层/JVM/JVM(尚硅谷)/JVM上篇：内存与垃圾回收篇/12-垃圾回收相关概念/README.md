...
![image-20221229174431902](./assets/image-20221229174431902.png)
...
![image-20221229174439538](./assets/image-20221229174439538.png)
...
![image-20221229174446222](./assets/image-20221229174446222.png)
...
![image-20221229174454403](./assets/image-20221229174454403.png)

#### 并发（Concurrent）

指用户线程与垃圾收集线程同时执行（但不一定是并行的，可能会交替执行），垃圾回收线程在执行时不会停顿用户程序的运行。用户程序在继续运行，而垃圾收集程序线程运行于另一个 CPU 上；如：CMS、G1

![image-20221229174501759](./assets/image-20221229174501759.png)
...
![image-20221229174517173](./assets/image-20221229174517173.png)
...
![image-20221229174525265](./assets/image-20221229174525265.png)
...
![image-20221229174532369](./assets/image-20221229174532369.png)
