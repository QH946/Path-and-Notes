...
![image-20221229173700777](./assets/image-20221229173700777.png)
...
![image-20221229173707547](./assets/image-20221229173707547.png)
...
![image-20221229173715953](./assets/image-20221229173715953.png)
...
![image-20221229173724102](./assets/image-20221229173724102.png)

### 小结

![image-20221229173732301](./assets/image-20221229173732301.png)

## 8.3. 对象的访问定位

![image-20221229173739532](./assets/image-20221229173739532.png)

JVM 是如何通过栈帧中的对象引用访问到其内部的对象实例呢？

![image-20221229173746484](./assets/image-20221229173746484.png)

### 8.3.1. 句柄访问

![image-20221229173754438](./assets/image-20221229173754438.png)

reference 中存储稳定句柄地址，对象被移动（垃圾收集时移动对象很普遍）时只会改变句柄中实例数据指针即可，reference 本身不需要被修改

### 8.3.2. 直接指针（HotSpot 采用）

![image-20221229173802932](./assets/image-20221229173802932.png)
...
![image-20221229173810525](./assets/image-20221229173810525.png)

### 8.4.3. 直接缓存区

使用 NIO 时，操作系统划出的直接缓存区可以被 java 代码直接访问，只有一份。NIO 适合对大文件的读写操作。

![image-20221229173820046](./assets/image-20221229173820046.png)
...
![image-20221229173828567](./assets/image-20221229173828567.png)
