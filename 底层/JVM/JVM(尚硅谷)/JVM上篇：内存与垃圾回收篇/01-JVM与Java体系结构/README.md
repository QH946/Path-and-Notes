...
<img src="./assets/image-20221229172056638.png" alt="image-20221229172056638" style="zoom:80%;" />
...
![image-20221229172107657](./assets/image-20221229172107657.png)
...
![image-20221229172115973](./assets/image-20221229172115973.png)

垃圾收集机制为我们打理了很多繁琐的工作，大大提高了开发的效率，但是，垃圾收集也不是万能的，懂得 JVM 内部的内存结构、工作机制，是设计高扩展性应用和诊断运行时问题的基础，也是 Java 工程师进阶的必备能力。

## 1.2. 面向人群及参考书目

![image-20221229172124757](./assets/image-20221229172124757.png)

![image-20221229172134037](./assets/image-20221229172134037.png)

![image-20221229172142001](./assets/image-20221229172142001.png)

![image-20221229172148842](./assets/image-20221229172148842.png)
...
![image-20221229172157738](./assets/image-20221229172157738.png)

每个语言都需要转换成字节码文件，最后转换的字节码文件都能通过 Java 虚拟机进行运行和处理

![image-20221229172205912](./assets/image-20221229172205912.png)
...
![image-20221229172215554](./assets/image-20221229172215554.png)
...
![image-20221229172224928](./assets/image-20221229172224928.png)
...
![image-20221229172259868](./assets/image-20221229172259868.png)
...
![image-20221229172309736](./assets/image-20221229172309736.png)

JVM 是运行在操作系统之上的，它与硬件没有直接的交互
![image-20221229172319490](./assets/image-20221229172319490.png)

## 1.6. JVM 的整体结构

![image-20221229172328021](./assets/image-20221229172328021.png)
...
![image-20221229172336516](./assets/image-20221229172336516.png)
